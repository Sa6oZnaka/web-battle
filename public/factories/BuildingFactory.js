...
export class BuildingFactory {
    ...
    static mine() {
        let upgrades = [
            ...
            [new Resource(ResourceEnum.GOLD, 5), new Resource(ResourceEnum.STONES, 100), new Resource(ResourceEnum.WOOD, 50)],
            [new Resource(ResourceEnum.GOLD, 15), new Resource(ResourceEnum.STONES, 200), new Resource(ResourceEnum.WOOD, 100), new Resource(ResourceEnum.IRON, 20)],
    ...
    static sawmill() {
        let upgrades = [
            [new Resource(ResourceEnum.GOLD, 1)],
            [new Resource(ResourceEnum.GOLD, 5), new Resource(ResourceEnum.WOOD, 100)],
            [new Resource(ResourceEnum.GOLD, 15), new Resource(ResourceEnum.WOOD, 200), new Resource(ResourceEnum.STONES, 50)],
            [new Resource(ResourceEnum.GOLD, 50), new Resource(ResourceEnum.WOOD, 400), new Resource(ResourceEnum.STONES, 100), new Resource(ResourceEnum.IRON, 40)],
            [new Resource(ResourceEnum.GOLD, 200), new Resource(ResourceEnum.WOOD, 800), new Resource(ResourceEnum.STONES, 300), new Resource(ResourceEnum.IRON, 100)]
        ];
        ...
        let products = [
            [new Resource(ResourceEnum.WOOD, 20)],
            [new Resource(ResourceEnum.WOOD, 40)],
            [new Resource(ResourceEnum.WOOD, 80)],
            [new Resource(ResourceEnum.WOOD, 100)],
            [new Resource(ResourceEnum.WOOD, 200)]
        ];

        return new Building(BuildingEnum.SAWMILL, upgrades, required, products);
    }
